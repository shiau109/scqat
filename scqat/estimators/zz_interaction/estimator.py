...
from scqat.estimators.zz_interaction.visualization import (
    plot_raw_with_overlay,
    plot_zz_value,
)


class ZZInteractionEchoEstimator(BaseEstimator):
    """
    ...
    deliberate: the estimator never mutates its input (qcat divided the ``time``
