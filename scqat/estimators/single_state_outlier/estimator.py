...
from scqat.tools.fit_gaussian2d import FitGaussian2D
from scqat.estimators.single_state_outlier.visualization import (
...
class SingleStateOutlierEstimator(BaseEstimator):
    """
    ...
    estimator_name = "single_state_QND"
    ...
    def extract_parameters(self, dataset: xr.Dataset, **kwargs) -> Dict[str, Any]:
        ...
        Kwargs:
            ...
            fixed_std (float): Fixed Gaussian std — skips fitting.
                When both fixed_mean and fixed_std are given, the estimator runs
